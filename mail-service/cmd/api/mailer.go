...
func (m *Mail) buildHTMLMessage(msg Message) (string, error) {
	tmplToRend := "./templates/mail.html.gohtml"

	t, err := template.New("email-html").ParseFiles(tmplToRend)
	if err != nil {
		return "", err
	}
...
func (m *Mail) buildPlainTextMsg(msg Message) (string, error) {
	tmplToRend := "./templates/mail.plain.gohtml"

	t, err := template.New("email-plain").ParseFiles(tmplToRend)
	if err != nil {
		return "", err
	}
